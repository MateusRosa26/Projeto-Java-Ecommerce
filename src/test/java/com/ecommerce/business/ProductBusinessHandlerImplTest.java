...
class ProductBusinessHandlerImplTest {
    ...
    void listWithFilter_ShouldReturnFilteredResults() {
        ...
        handler.create(new ProductDto(1L, "Teclado", 199.99f, "1234567890123", "Teclado mecânico", "teclado.jpg"));
        handler.create(new ProductDto(2L, "Mouse", 89.99f, "1234567890124", "Mouse óptico", "mouse.jpg"));
        handler.create(new ProductDto(3L, "Monitor", 599.99f, "1234567890125", "Monitor LED", "monitor.jpg"));
